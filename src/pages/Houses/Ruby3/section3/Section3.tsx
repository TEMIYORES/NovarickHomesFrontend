...
const className = "ruby3-section3-container-bottom-item-icon";
...
const Section3 = () => {
  return (
    <>
      <div className="ruby3-section3">
        <div className="ruby3-section3-container">
          <div className="ruby3-section3-container-top">
            <div className="ruby3-section3-container-top-title1">
              Property Amenities
            </div>
            <div className="ruby3-section3-container-top-title2">
              Ruby II embodies living in bliss and comfort
            </div>
          </div>
          <div className="ruby3-section3-container-bottom">
            {itemData.map((item) => {
              return (
                <div
                  key={item.title}
                  className="ruby3-section3-container-bottom-item"
                >
                  {item.icon}
                  <div className="ruby3-section3-container-bottom-item-desc">
                    {item.title}
                  </div>
                </div>
              );
