...
const Section3 = () => {
  return (
    <>
      <div className="buyback-section3">
        <div className="buyback-section3-container">
          <div className="buyback-section3-container-top">
            <div className="buyback-section3-container-top-title1">
              About Ruby3 Project
            </div>
            <div className="buyback-section3-container-top-title2">
              Ruby II embodies living in bliss and comfort
            </div>
          </div>
          <div className="buyback-section3-container-bottom">
            {itemData.map((data) => {
              return (
